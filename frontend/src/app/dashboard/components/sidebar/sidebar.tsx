...
import { Upload, Settings, Battery as Gallery, Home, Menu, Sparkles, History, User } from "lucide-react"
      ...
      <div className="p-4 border-t border-sidebar-border">
        ...
        >
          ...
          <div className="flex flex-col items-start">
            ...
            <span className="text-xs opacity-60">Conta e configurações</span>
          </div>
        </Button>
      </div>
    </div>
...
export function MobileSidebar({ currentPage, onPageChange }: Omit<SidebarProps, "className">) {
